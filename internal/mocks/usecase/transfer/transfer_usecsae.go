...
import (
	...
	usecasetransfer "shop-service/internal/usecase/transfer"
)
...
func (_m *TransferUsecsae) SendCoins(ctx context.Context, req usecasetransfer.SendCoinsRequest) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, usecasetransfer.SendCoinsRequest) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
